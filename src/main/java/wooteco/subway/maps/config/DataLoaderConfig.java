...
public class DataLoaderConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Line line1 = new Line("신분당선", "red lighten-1", LocalTime.now(), LocalTime.now(), 10, new ExtraFare(500));
        Line line2 = new Line("2호선", "green lighten-1", LocalTime.now(), LocalTime.now(), 10, new ExtraFare(0));
        Line line3 = new Line("3호선", "orange darken-1", LocalTime.now(), LocalTime.now(), 10, new ExtraFare(900));
