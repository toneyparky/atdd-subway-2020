...
public class MapServiceTest {
    ...
    void setUp() {
        ...
        Line line1 = TestObjectUtils.createLine(1L, "2호선", "GREEN", new ExtraFare(0));
        ...
        Line line2 = TestObjectUtils.createLine(2L, "신분당선", "RED", new ExtraFare(500));
    ...
    void findPath() {
        ...
        PathResponse pathResponse = mapService.findPath(1L, 3L, PathType.DISTANCE, new LoginMember(1L, "a@a", "qw", 20));
